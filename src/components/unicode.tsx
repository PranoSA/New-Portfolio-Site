...
const UnicodePanel = (props: UnicodePanelProps) => {
  ...
  return (
    <div className=" flex flex-around flex-wrap w-full p-15">
      ...
      <div className="w-full p-4 justify-center text-center">
        <h1 className="w-full text-3xl font-bold"> Mini Demonstration : </h1>
      </div>
      ...
      <div className="w-full p-4 justify-center text-center">
        ...
        <table className="table-auto w-full">
          <tbody>
              <tr>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">Name:</td>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">{props.unicode_info?.na}</td>
              </tr>
              <tr>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">Block:</td>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">{props.unicode_info?.blk}</td>
              </tr>
              <tr>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">Codepoint:</td>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">{props.unicode_info?.cp}</td>
              </tr>
              <tr>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">Name Alias:</td>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">{props.unicode_info?.na1}</td>
              </tr>
              <tr>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">Decomposition:</td>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">{props.unicode_info?.dm}</td>
              </tr>
              <tr>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">General Category:</td>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">{props.unicode_info?.gc}</td>
              </tr>
              <tr>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">Script:</td>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">{props.unicode_info?.sc}</td>
              </tr>
              
              <tr>
                <td className="border-3 border-gray-300 px-4 py-2 w-1/2">Examination Link:</td>
                ...
                <h2 className={`mb-3 text-sm font-semibold font-gray`}>
                </h2>
              )}
                </td>
              </tr>
